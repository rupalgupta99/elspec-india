document.addEventListener('DOMContentLoaded', function () {
  ...
  if (slides.length > 1) {
    ...
    var heroContent = [
      ...
      ['Case Study', 'Textile Mill Case Study', 'Power quality monitoring and improvement at an Indian textile mill.', 'Read Case Study', 'case-study-shree-dinesh-mill.html', 'View All Case Studies', 'insights.html#case-studies'],
